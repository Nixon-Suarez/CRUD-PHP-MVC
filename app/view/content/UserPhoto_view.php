...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
            <?php if(!empty($datos['usuario_foto']) && file_exists("./app/view/fotos/".$datos['usuario_foto'])){ ?>
            ...
            <?php } else { ?>
                <figure class="image mb-6">
                    <img class="is-rounded" src="<?php echo APP_URL;?>app/view/img/Captura de pantalla 2025-06-20 191843.png">
                </figure>
            <?php } ?>
		</div>
		<div class="column">
